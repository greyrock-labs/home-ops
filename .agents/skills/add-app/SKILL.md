...
```yaml
---
# yaml-language-server: $schema=https://k8s-schemas.greyrock.io/kustomize.toolkit.fluxcd.io/kustomization_v1.json
...
```yaml
---
# yaml-language-server: $schema=https://k8s-schemas.greyrock.io/source.toolkit.fluxcd.io/ocirepository_v1.json
...
```yaml
---
# yaml-language-server: $schema=https://k8s-schemas.greyrock.io/external-secrets.io/externalsecret_v1.json
